...
class insulationMass(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('batt_cutout_w', 0.050038,   units='m', desc='width of the cutout for the cell, slightly larger than width of cell')
        ...
        self.add_input('t_pad',0.002,   units='m', desc='thickness of the pcm insulation layer')
        self.add_input('XS:W_hp', 0.025,   units='m', desc='width of the heatpipe')
    ...
    def compute(self, inputs, outputs):
        ...
        outputs['ins_pcm_layer_volume'] = outputs['ins_pcm_layer_area'] * t_pad * num_stacks
        outputs['ins_pcm_layer_mass'] = outputs['ins_pcm_layer_volume'] * ins_density * num_stacks

        outputs['ins_hp_layer_area'] = (outputs['ins_cell_tray_area'] - (hp_w  * outputs['L_ins'] * num_hp)) * num_stacks
