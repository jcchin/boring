...
class insulationMass(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('ins_density', 160, units='kg/m**3', desc='density of the insulation material')
    ...
    def compute(self, inputs, outputs):
        ...
        outputs['ins_volume'] = (outputs['ins_backing_area'] + outputs['ins_side_sep_area']) * ins_thickness
