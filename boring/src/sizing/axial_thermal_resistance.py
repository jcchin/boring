...
class AxialThermalResistance(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('k_l', 1, desc='liquid conductivity')
        self.add_input('L_adiabatic', 1, units='m', desc='Adiabatic Length')
        self.add_input('A_w', 1, units='m**2', desc='Wall Area')
        self.add_input('A_wk', 1, units='m**2', desc='Wick Area')
